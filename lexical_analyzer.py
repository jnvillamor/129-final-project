...
class LexicalAnalyzer: 
  ...
  Stores the keywords, variables, integers, and operators.
  ...
  def __init__(self):
    ...
    self.errors = [] # List of errors raised by the Lexical Analyzer
  ...
  def _isValidVariable(self, input):
    # Regex pattern for a valid identifier (variable name) without underscores or special characters
  ...
  def _raiseError(self, word):
    ...
    self.errors.append("Error found at line " + str(self.current_line_number) + ": Unknown word " + word)
  ...
  def tokenizeInput(self, current_input):
    # Tokenize the input code
      ...
      self.current_line_number = 0 # Reset line number
  ...
  def tokenizeWord(self, word):
    # Iterate through each valid lexeme and return the token
      ...
      return "ERR_LEX" # Return the word if it is not a valid lexeme
